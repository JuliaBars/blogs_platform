...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='description',
            field=models.TextField(help_text='Напишите о чём ваша группа', verbose_name='Описание группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(help_text='Придумайте человекочитаемый адрес', unique=True, verbose_name='Адрес url для группы'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
        ...
        migrations.AlterField(
            model_name='post',
            name='text',
            field=models.TextField(help_text='Напишите ваш пост', validators=[posts.validators.validate_not_empty], verbose_name='Текст поста'),
        ),
    ]
